...
values."
  ...
  (setq local-elpa-mirror-path "~/.emacs.d/spacemacs-elpa-mirror/")
  (setq configuration-layer-elpa-archives
  `(("melpa" . ,(concat local-elpa-mirror-path "melpa/"))
    ("org"   . ,(concat local-elpa-mirror-path "org/"))
    ("gnu"   . ,(concat local-elpa-mirror-path "gnu/"))))
